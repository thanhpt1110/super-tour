    ...
    internal class MainTourViewModel: ObservableObject
    {
        ...
        private void ExecuteUpdateTourCommand(object obj)
        {
            try
            {
                ...
                {
                    UpdateTourViewModel updateTourViewModel = new UpdateTourViewModel(SelectedItem, this, mainViewModel);
        ...
        private async void ExecuteDeleteTour(object obj)
        {
            try
            {
                if(SelectedItem.TRAVELs.Count>0)
                {
                    MyMessageBox.ShowDialog("You couldn't delete this tour.", "Warning", MyMessageBox.MessageBoxButton.OK, MyMessageBox.MessageBoxImage.Warning);
                    return;
                }    
